export const articleData = [
  ...
  {
    id: '2',
    title: 'Egyptian Gods and Goddesses: A Complete Guide',
    slug: 'egyptian-gods',
    category: 'mythology',
    date: 'March 22, 2023',
    readTime: 12,
  ...
  {
    id: '3',
    title: 'The Great Pyramids: Engineering Marvels of the Ancient World',
    slug: 'great-pyramids',
  ...
  {
    id: '4',
    title: 'Hieroglyphics: Decoding the Ancient Egyptian Writing System',
    slug: 'hieroglyphics',
    category: 'art',
  ...
  {
    id: '5',
    title: 'The Mummification Process: Preparing for the Afterlife',
    slug: 'mummification-process',
    category: 'daily-life',
  ...
  {
    id: '7',
    title: 'The Book of the Dead: Ancient Egyptian Funerary Texts',
  ...
  {
    id: '8',
    title: 'The Temple of Karnak: Largest Religious Complex of Ancient Egypt',
    slug: 'temple-of-karnak',
    category: 'architecture',
  ...
  {
    id: '9',
    title: 'Egyptian Jewelry: Symbols of Power and Protection',
    slug: 'egyptian-jewelry',
    category: 'art',
    date: 'August 5, 2022',
    readTime: 6,
